...
const Categories = () => {
    ...
    let catogires = [
        {img: silverImg, title: 'silver_products',link: '/silver-products'},
        {img: goldImg, title: 'gold_products',link: '/gold-products'},
        {img: goldWithDiamondImg, title: 'goldwdiamond_products',link: '/goldwdiamond_product'}
    ]
